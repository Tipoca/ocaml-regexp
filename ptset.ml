...
(*i $Id: ptset.ml,v 1.2 2002/03/25 14:01:14 marche Exp $ i*)
...
let add k t =
  let rec ins = function
    | Empty -> Leaf k
    | Leaf j as t -> 
	if j == k then t else join (k.tag, Leaf k, j.tag, t)
...
let rec equalq t1 t2 = 
  match (t1,t2) with
    | Empty,Empty -> true
    | Leaf k, Leaf j -> k==j
    | Branch(p1,m1,l1,r1),Branch(p2,m2,l2,r2) ->
	p1==p2 && m1==m2 && equalq l1 l2 && equalq r1 r2
    | _ -> false
;;
